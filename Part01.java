public class Part01 {
  ...
  static void prologue() {
    ...
    System.out.println("姫を攫われて" + team[en] + "は、頭を抱えている");
  }

  static void summon() {
    System.out.println(team[en] + "は、世界を救うため" + team[en] + "に命令を下した！！");
    System.out.println(team[en] + "はレベル" + lv + "の" + team[en] + "を召喚した");
  ...
  static void attack() {
    ...
    if(lv > 50) {
      ...
      System.out.println(team[en] + "は、姫を救うように見せかけ、裏で" + team[en] + "を暗殺して王国を裏で操った！");
